var basicAjaxExample = require('./super-selects/basic-ajax'),
    ...
    customSelectedValueTemplate = require('./super-selects/custom-selected-value-template'),
    ...
    onOpenCallback = require('./super-selects/on-open-callback'),
