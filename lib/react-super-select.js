...
var ReactSuperSelect = React.createClass({
  ...
  componentDidMount: function componentDidMount() {
    ...
    // this.refs.rssControl.addEventListener('click', this._arrestEvent);
    // this.refs.rssControl.addEventListener('touchstart', this._arrestEvent);
  },
  ...
  _closeOnKeypress: function _closeOnKeypress() {
    console.log('called _closeOnKeypress');
    if (this.state.isOpen) {
      this.setState({
        isOpen: false,
        focusedId: undefined
  ...
  // focus the main trigger element of the control if the user is interacting with this control
  ...
  _handleDocumentClick: function _handleDocumentClick(event) {
    console.log('>>>>>', this.refs.rssControl.contains(event.target));
