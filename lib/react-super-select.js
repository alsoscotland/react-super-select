...
var ReactSuperSelect = React.createClass({
  ...
  _findOptionDataObjectsByValue: function _findOptionDataObjectsByValue(value) {
  ...
  _generateValueDiplay: function _generateValueDiplay() {
  ...
  _getHiddenSelectElement: function _getHiddenSelectElement() {
    ...
    return React.createElement(
      "select",
      { ref: "hiddenSelect", className: "r-ss-hidden" },
      optionsMarkup
    );
  },
  ...
  _mapDataToCustomOptionMarkup: function _mapDataToCustomOptionMarkup() {
    ...
    return _.map(data, function (dataOption, index) {
      ...
      return React.createElement(
        "li",
        { ref: indexRef, tabIndex: "0", className: classes, key: itemKey, "data-option-value": dataOption[valueKey], onClick: self._selectItem, role: "menuitem" },
        customOptionMarkup
      );
    });
  },
