...
describe("ReactSuperSelect", function () {
  ...
  var renderComponent = function renderComponent(userProps) {
  ...
  describe("hidden select element", function () {
    ...
    beforeEach(function () {
      mockData = [{ id: 1, name: "option one", blah: "blah one" }, { id: 2, name: "option two", blah: "blah two" }];
    });
  ...
  describe("dropdown template content", function () {
    ...
    beforeEach(function () {
      mockData = [{ id: 1, name: "option one", blah: "blah one", fancyprop: "I am a fancy one" }, { id: 2, name: "option two", blah: "blah two", fancyprop: "I am a fancy two" }];
    });
    ...
    it("renders custom list item content when a mapper function is provided", function () {
      var el = renderComponent({
        dataSource: mockData,
        customOptionsMapper: function customOptionsMapper(option) {
  ...
  describe("search results filter", function () {
    ...
    beforeEach(function () {
      mockData = [{ id: 1, name: "option one", blah: "blah one", fancyprop: "I am a fancy one" }, { id: 2, name: "option two", blah: "blah two", fancyprop: "I am a fancy two" }, { id: 3, name: "option three", blah: "blah three", fancyprop: "I am a fancy three" }];
    });
    ...
    it("filters by custom filter function", function () {
      var el = renderComponent({
        dataSource: mockData,
        customFilterFunction: function customFilterFunction(option) {
